...
def generar_graficas_telemetria():
    ...
    # Dibujar la trazada del coche coloreada por velocidad
    ...
    plt.axis('equal') # Para que el circuito no se vea deformado
    plt.legend()
    plt.tight_layout()
    plt.show()
    ...
    # B. Pedales (Acelerador > 0, Freno < 0)
    # Coloreamos de verde cuando acelera y de rojo cuando frena
    ...
    # ==========================================
    # GRÁFICA 3: MAPA DE ACCIONES (Pedal vs Dirección)
    # ==========================================
