...
# Leer un archivo CSV
df = pd.read_csv('D://Aplicaciones//TFG2//Datasets//telemetria_Vers_CarCompl_0.1seg.csv')
...
#ruta_guardado = 'D://Aplicaciones//TFG2//Training//SavedModels_Supervisado//motor_fisicas_MLP_0.05seg.joblib'
